...
if __name__ == "__main__":
    try:
        ...
        #Creating the forecasting function using neuralforecast with frequency as Monthly and predict the price for houses with three bedrooms for the next four months. review_scores_rating is used as the exogenous variable.
        cursor.query("""
